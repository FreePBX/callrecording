...
function callrecording_get_config($engine) {
	...
	case 'asterisk':
		...
		*/
		...
		$ext->add($context, $exten, '', new ext_set('_LOCAL_MIXMON_ID','${TIMESTR}-${UNIQUEID}'));
		$ext->add($context, $exten, 'monitorcmd', new ext_mixmonitor('${MIXMON_DIR}${YEAR}/${MONTH}/${DAY}/${CALLFILENAME}.${MON_FMT}','a${MONITOR_REC_OPTION}i(${LOCAL_MIXMON_ID})${MIXMON_BEEP}','${MIXMON_POST}'));
