...
function callrecording_get_config($engine) {
	...
	case 'asterisk':
		...
		*/
		...
		$ext->add($context, $exten, '', new ext_set('__CLEAN_DESTINATION','${STRREPLACE(ARG3,"-","")}'));
		$ext->add($context, $exten, '', new ext_set('__CALLFILENAME','${ARG2}-${CLEAN_DESTINATION}-${FROMEXTEN}-${TIMESTR}-${UNIQUEID}'));
